    ...
    public partial class DettagliOrdine : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string SingleOrdineQuery =
                        $"SELECT D.FK_IdOrdine, D.FK_IdProdotto, D.Quantita, P.Immagine, P.Nome, P.Prezzo * D.Quantita AS TOTALE FROM DettagliOrdini AS D JOIN Prodotti AS P ON P.idProdotto = D.FK_IdProdotto WHERE D.FK_IdOrdine = {idOrdine}";
